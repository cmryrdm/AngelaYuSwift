...
struct StoryBrain {
    ...
    mutating func nextStory(_ userChoice: String) {
        storyNumber = (userChoice == stories[storyNumber].getChoice1()) ? stories[storyNumber].getChoice1Destination() : stories[storyNumber].getChoice2Destination()
        
        storyNumber = (storyNumber < stories.count) ? storyNumber : 0
    }
